...
namespace Listagem1_InsercaoFim
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            alunos.InsercaoFim("Ze", 123, new DateTime(1999, 12, 12), Curso.RSI);
            alunos.InsercaoFim("Francisco", 13, new DateTime(1999, 12, 12), Curso.PMJD);
            alunos.InsercaoFim("JoZe", 134, new DateTime(1999, 12, 12), Curso.RSI);
            alunos.InsercaoFim("Maria", 323, new DateTime(1999, 12, 12), Curso.RSI);
            ...
            {
                Console.Clear();
                Console.Write("O que deseja:\n \n1->Criar Antigo aluno novo\n2->Remover Antigo aluno\n3->Listar antigos alunos\n4->Ver alunos a partir de um curso inscrito\n" +
                "5->Sair\n\nUser: ");
                ...
                switch (user)
                {
                    case "1":
                        ...
                        try
                        {
                            ...
                            if (teste != null)
                            {
                                alunos.InsercaoFim(teste.Nome, teste.NumAluno, teste.DataNascimento, teste.CursoInscrito);
                                Console.Clear();
