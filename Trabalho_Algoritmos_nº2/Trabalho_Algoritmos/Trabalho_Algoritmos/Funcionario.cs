...
namespace Trabalho_Algoritmos
{
    ...
    class Funcionario
    {
        public enum EstadoCivil { Solteiro, Casado, Divorciado, Viúvo, Separado }
        private EstadoCivil situacaoMatrimonial;
        ...
        public string SituacaoMatrimonial
        {
            get
            {
                switch (situacaoMatrimonial)
                {
                    case EstadoCivil.Casado: return "Casado(a)";
                    case EstadoCivil.Divorciado: return "Divorciado(a)";
                    case EstadoCivil.Separado: return "Separado(a)";
                    case EstadoCivil.Viúvo: return "Viuvo(a)";
            ...
            set
            {
                switch (value.ToLower())
                {
                    ...
                    case "casada":
                    case "cas":
                        situacaoMatrimonial = EstadoCivil.Casado;
                        break;
                    case "divorciado":
                    case "divorciada":
                    case "div":
                        situacaoMatrimonial = EstadoCivil.Divorciado;
                        break;
                    case "separado":
                    case "separada":
                    case "sep":
                        situacaoMatrimonial = EstadoCivil.Separado;
                        break;
                    case "viuvo":
                    case "viuva":
                    case "viu":
                        situacaoMatrimonial = EstadoCivil.Viúvo;
                        break;
                    case "solteiro":
                    case "solteira":
                    case "sol":
                        situacaoMatrimonial = EstadoCivil.Solteiro;
                        break;
